...
window.addEventListener('scroll',(e)=>{
    ...
    if(scroll==0){
      animation1();
    }else if(scroll>600 && scroll<790){
      animation2();
    }
    else if(scroll>770 && scroll<1540){
      animation3();
  
    }else if(scroll>1550 && scroll<2300){
      animation4();
    }else if(scroll>2310 && scroll<3060){
      animation5();
    }else if(scroll>3080 && scroll<3820){
      animation6();
    }else if(scroll>3840 && scroll<4590){
      animation7();
    }
  })
